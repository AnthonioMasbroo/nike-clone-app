...
import { ArrowLeft, Inbox, ShoppingBag } from 'react-native-feather';
        ...
        <SafeAreaView className="flex-1 bg-white px-2 py-2">
            <View className="pt-12 pb-4 flex-row justify-between items-center">
                <TouchableOpacity onPress={() => navigation.goBack()} className='flex-row items-center'>
                    ...
                    <Text className="text-lg text-black pl-6 font-montserrat-semibold">Sneakers of the Week</Text>
                </TouchableOpacity>
            ...
            <FlatList
                ...
                renderItem={({ item: product }) => (
                    <TouchableOpacity
                        style={{ width: '50%', padding: 4, marginBottom: 4 }}
                    ...
                    >
                        ...
                        <Text className="font-montserrat-medium text-sm">Rp{product.price.toLocaleString()}</Text>
                    </TouchableOpacity>
                )}
